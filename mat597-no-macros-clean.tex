...
\be
\left| {RF\cdot F} \right| = \left\langle {\overline{F}(\sigma)  F(R\sigma)}\right\rangle\ge 0.
\ee
\end{definition}
...
\be
\left\langle {\prod_\alpha F_\alpha(\sigma_\alpha)}\right\rangle \le \prod_\alpha \left\langle {\prod_{\alpha'} F_\alpha^{\#} (\sigma_{\alpha'})}\right\rangle,
\ee
...
\begin{array}{|c|c|}
\hline
\rotatebox[origin=c]{180}{\textnormal{F}} &\rotatebox[origin=c]{180}{\reflectbox{\textnormal{F}}} \\
\hline
\reflectbox{\textnormal{F}}& \textnormal{F}\\
\hline
\end{array}
\ee
\end{theorem}
